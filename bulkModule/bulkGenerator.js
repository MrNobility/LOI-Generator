...
function renderCollapsibleLOIBlock(dealData, index) {
  ...
  header.innerHTML = `Deal ${index + 1}: ${dealData.fullAddress || "Unnamed Property"} ▼`;
  ...
  sellerFinanceBlock.innerHTML = `<h3 class="font-bold mb-2 text-blue-700">Seller Finance LOI</h3>${dealData.sellerFinanceLOI}`;
  ...
  cashBlock.innerHTML = `<h3 class="font-bold mb-2 text-green-700">Cash Offer LOI</h3>${dealData.cashLOI}`;
